...
pipelineJob(pipelineBeingGeneratedName) {
    ...
    parameters {
        ...
        stringParam('SLAVE_LABEL', 'fem5dockerslave6', 'Specify the slave label that you want the job to run on')
    ...
    definition {
        cpsScm {
            ...
            scriptPath('cicd_files/external/jenkins/files/fem5s11_eiffel052/FileTransferBetweenAgents.Jenkinsfile')
        }
    }
}
