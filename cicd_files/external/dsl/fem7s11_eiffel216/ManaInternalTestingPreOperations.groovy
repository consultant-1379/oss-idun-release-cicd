...
pipelineJob(pipelineBeingGeneratedName) {
    ...
    parameters {
        stringParam("SLAVE_LABEL", "RHEL7_GE_Docker_1", "Label of the Jenkins slave where this jenkins job should be executed.")
    ...
    definition {
        cpsScm {
            ...
            scriptPath('cicd_files/external/jenkins/files/fem7s11_eiffel216/ManaInternalTestingPreOperations.Jenkinsfile')
        }
    }
}
