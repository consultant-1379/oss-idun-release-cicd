def pipelineBeingGeneratedName = "oss-idun-release-cicd_MANA_Health_Check"
...
<div style="width:fit-content;background:#fbf6e1;padding:1em;border-radius:1em;box-shadow: 0 0.1em 0.3em #525000">
    ...
    <p>This job checks the status of the Deployment using HELM on MANA environments.</p>
    <p style="text-align:center"><b>&#x26A1; Job developed and maintained by Thunderbee &#x26A1;</b><br/>
    <a href="mailto:PDLENMCOUN@pdl.internal.ericsson.com?Subject=oss-idun-release-cicd_MANA_Health_Check%20Job">&#128231; Send Mail to provide feedback</a></p>
</div>
""")
