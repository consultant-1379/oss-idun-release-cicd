...
pipelineJob(pipelineBeingGeneratedName) {
    ...
    parameters {
        ...
        stringParam('SLAVE_LABEL', 'RHEL7_GE_Docker_1', 'Specify the slave label that you want the job to run on.')
    }
    ...
    definition {
        cpsScm {
            ...
            scriptPath('cicd_files/external/jenkins/files/fem7s11_eiffel216/AutoAppsBuildAndUploadCSAR.Jenkinsfile')
        }
    }
